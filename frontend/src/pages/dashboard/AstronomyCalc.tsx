...
import SunIcon from 'components/moon-phase/images/sun.png'
        ...
        <div className='box astronomy-calc'>
            <Grid>
                <Grid.Column width={8}>
                    ...
                    <div>
                        ↑ Окончание сумерек:{' '}
                        <strong>{moment(sunTimes.dawn).format('H:mm')}</strong>
                    </div>
                    <div>
                        ↓ Начало сумерек:{' '}
                        <strong>{moment(sunTimes.dusk).format('H:mm')}</strong>
                    </div>
                    <div>
                        Высота: <strong>{sunAltitude}°</strong>
                    </div>
                    <div>
                        Азимут: <strong>{sunAzimuth}°</strong>
                    </div>
                </Grid.Column>
                <Grid.Column width={8}>
                    <h4>
                    ...
                    <div>
                        ↑ Восход{' '}
                        <strong>{moment(moonTimes.rise).format('H:mm')}</strong>
                    </div>
                    <div>
                        ↓ Закат{' '}
                        <strong>{moment(moonTimes.set).format('H:mm')}</strong>
                    </div>
                    <div>
                        Высота: <strong>{moonAltitude}°</strong>
                    </div>
                    <div>
                        Азимут: <strong>{moonAzimuth}°</strong>
                    </div>
                </Grid.Column>
            </Grid>
        </div>
